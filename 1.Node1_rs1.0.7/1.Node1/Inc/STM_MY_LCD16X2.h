...
#define	CRT_PORT	GPIOB
#define CRT_PIN		GPIO_PIN_1
#define Lcd1602_ON()	HAL_GPIO_WritePin(CRT_PORT, CRT_PIN, GPIO_PIN_SET)
#define Lcd1602_OFF() HAL_GPIO_WritePin(CRT_PORT, CRT_PIN, GPIO_PIN_RESET)

#define	LCD_IP_PORT	GPIOB
#define LCD_IP_PIN	GPIO_PIN_0

#define Lcd_button() HAL_GPIO_ReadPin(LCD_IP_PORT, LCD_IP_PIN)

#define RS_GPORT	GPIOB
#define RS_GPIN	GPIO_PIN_8

#define EN_GPORT	GPIOB
#define EN_GPIN	GPIO_PIN_7

#define D4_GPORT	GPIOB
#define D4_GPIN	GPIO_PIN_6

#define D5_GPORT	GPIOB
#define D5_GPIN	GPIO_PIN_5

#define D6_GPORT	GPIOB
#define D6_GPIN	GPIO_PIN_4

#define D7_GPORT	GPIOB
#define D7_GPIN	GPIO_PIN_3
